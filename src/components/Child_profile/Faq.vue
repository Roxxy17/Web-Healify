<template>
<div
    class="relative w-full bg-[#75C2F6] bg-opacity-50 px-6 pt-10 pb-8 mt-8 mb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
    <div class="mx-auto px-5">
        <div class="flex flex-col items-center">
            <h2 class="mt-5 text-center text-3xl font-bold tracking-tight md:text-5xl text-[#1D5D9B] drop-shadow-md">FAQ</h2>
            <p class="mt-3 text-lg text-neutral-500 md:text-xl drop-shadow-md">Frequenty asked questions
