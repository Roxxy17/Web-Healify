<template>
  ...
  <section class="pt-10 bg-gray-200">
    <h1 class="text-[#1D5D9B] font-[inter] text-4xl font-bold mb-10 ml-8">
      Dengarkan Music Sesuai Mood Kamu
    </h1>
    <div class="container">
          ...
          <div class="bg-white rounded-lg overflow-hidden">
            ...
            <div class="p-8 sm:p-9 md:p-7 xl:p-9 text-center">
              <h3>
                ...
                >
                  20+ Musik Terbaik Dengan Suasana Baru Yang Bisa Menghilangkan
                  Stressmu.
                </a>
              </h3>
              <p class="text-base text-body-color leading-relaxed mb-7">
                Musik yang dapat membantu mu untuk mengurangi dan mengelola
                stressmu.
              </p>
              <a
                href="javascript:void(0)"
            ...
            <div class="p-8 sm:p-9 md:p-7 xl:p-9 text-center">
              <h3>
                <a
                  ...
                  class="font-semibold text-dark text-xl sm:text-[22px] md:text-xl lg:text-[22px] xl:text-xl 2xl:text-[22px] mb-4 block hover:text-primary"
                >
                  10+ Musik untuk kamu yang ingin Bermeditasi dengan tenang dan
                  nyaman .
                </a>
              </h3>
              <p class="text-base text-body-color leading-relaxed mb-7">
                Musik yang cocok untuk menemani mu untuk bermeditasi dan juga
                bersantai.
              </p>
              <a
                href="javascript:void(0)"
            ...
            <div class="p-8 sm:p-9 md:p-7 xl:p-9 text-center">
              <h3>
                <a
                  ...
                  class="font-semibold text-dark text-xl sm:text-[22px] md:text-xl lg:text-[22px] xl:text-xl 2xl:text-[22px] mb-4 block hover:text-primary"
                >
                  15+ musik agar kamu bisa makin produktif dalam menghadapi
                  keseharianmu.
                </a>
              </h3>
              <p class="text-base text-body-color leading-relaxed mb-7">
                Musik biar bisa makin produktif dan semangat dalam beraktifitas.
              </p>
              <a
                href="javascript:void(0)"
                class="inline-block py-2 px-7 border border-[#E5E7EB] rounded-full text-base text-body-color font-medium hover:border-primary hover:bg-primary hover:text-white transition"
